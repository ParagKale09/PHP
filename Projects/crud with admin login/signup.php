...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $existSql = "SELECT * FROM `logininfo` WHERE username = '$username'";
    ...
    if($numExistRows > 0){
        ...
        if(($password == $cpassword)){
            ...
            $sql = "INSERT INTO `logininfo` ( `username`, `password`, `dt`) 
...
<html lang="en">
  ...
  <body>
    ...
    <img src="/crud/logo.png" height="95px" alt="paris" class="center">
     <h1 class="text-center">Signup(User) to CRUD</h1>
